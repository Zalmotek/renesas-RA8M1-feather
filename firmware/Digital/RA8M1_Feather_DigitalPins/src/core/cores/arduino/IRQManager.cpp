    ...
    /* **********************************************************************
       ...
       ********************************************************************** */
        ...
        if (p_cfg->txi_irq == FSP_INVALID_VECTOR) {
            ...
            *(irq_ptr + last_interrupt_index) = (uint32_t)sci_b_uart_txi_isr;
            ...
            *(irq_ptr + last_interrupt_index) = (uint32_t)sci_b_uart_tei_isr;
            ...
            *(irq_ptr + last_interrupt_index) = (uint32_t)sci_b_uart_rxi_isr;
            ...
            *(irq_ptr + last_interrupt_index) = (uint32_t)sci_b_uart_eri_isr;
    ...
    */
    ...
    /* **********************************************************************
       ...
       ********************************************************************** */
        ...
        spi_b_instance_ctrl_t * p_ctrl = reinterpret_cast<SpiMasterIrqReq_t *>(cfg)->ctrl;
        ...
        if (p_cfg->txi_irq == FSP_INVALID_VECTOR) {
            ...
            *(irq_ptr + last_interrupt_index) = (uint32_t)spi_b_txi_isr;
            ...
            *(irq_ptr + last_interrupt_index) = (uint32_t)spi_b_rxi_isr;
            ...
            *(irq_ptr + last_interrupt_index) = (uint32_t)spi_b_eri_isr;
            ...
            *(irq_ptr + last_interrupt_index) = (uint32_t)spi_b_tei_isr;
