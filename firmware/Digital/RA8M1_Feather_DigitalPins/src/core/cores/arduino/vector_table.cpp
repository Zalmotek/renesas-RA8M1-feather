...
BSP_DONT_REMOVE const fsp_vector_t g_vector_table[BSP_ICU_VECTOR_MAX_ENTRIES] BSP_PLACE_IN_SECTION(BSP_SECTION_APPLICATION_VECTORS) =
{
    ...
    [13] = sci_b_uart_txi_isr, /* SCI2 TXI (Transmit data empty) */
    [14] = sci_b_uart_tei_isr, /* SCI2 TEI (Transmit end) */
    [15] = sci_b_uart_rxi_isr, /* SCI2 RXI (Received data full) */
...
const bsp_interrupt_event_t g_interrupt_event_link_select[BSP_ICU_VECTOR_MAX_ENTRIES] =
{
    ...
    [12] = BSP_PRV_IELS_ENUM(EVENT_AGT0_INT), /* AGT0 INT (AGT interrupt) */
    ...
    [15] = BSP_PRV_IELS_ENUM(EVENT_SCI2_RXI), /* SCI2 RXI (Received data full) */
...
const bsp_interrupt_event_t g_interrupt_event_link_select[BSP_ICU_VECTOR_MAX_ENTRIES] = {(bsp_interrupt_event_t)0};
#endif
