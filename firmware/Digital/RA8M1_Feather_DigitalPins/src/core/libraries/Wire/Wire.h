...
#include "../../cores/arduino/api/HardwareI2C.h"
#include "../../cores/arduino/api/Stream.h"
#include <inttypes.h>
...
class TwoWire : public arduino::HardwareI2C {
  ...
  private:
    ...
    iic_master_instance_ctrl_t m_i2c_ctrl = g_i2c_master0_ctrl;
    i2c_master_cfg_t m_i2c_cfg = g_i2c_master0_cfg;
