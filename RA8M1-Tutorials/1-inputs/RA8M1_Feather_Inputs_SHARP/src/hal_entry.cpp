...
#define d5 (BSP_IO_PORT_04_PIN_07)
#define d6 (BSP_IO_PORT_04_PIN_14)
#define d9 (BSP_IO_PORT_04_PIN_15)
#define d10 (BSP_IO_PORT_01_PIN_12)
#define d12 (BSP_IO_PORT_01_PIN_13)
#define d13 (BSP_IO_PORT_01_PIN_14)
...
void hal_entry(void)
{
    R_IOPORT_PinWrite(&g_ioport_ctrl, d5, BSP_IO_LEVEL_HIGH);
    R_IOPORT_PinWrite(&g_ioport_ctrl, d6, BSP_IO_LEVEL_HIGH);
    R_IOPORT_PinWrite(&g_ioport_ctrl, d9, BSP_IO_LEVEL_HIGH);
    ...
    while (true) {
        ...
        double voltage = (adc_val * (3.3 / 4095.0));
        int distance = (27.86 * pow(voltage, -1.15));
        APP_PRINT("Distance: "); APP_PRINT("%d\n",distance);
        delay(500);
    }
